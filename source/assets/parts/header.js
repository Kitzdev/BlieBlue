...
<div class="d-flex align-items-center justify-content-around bg-transparent flex-wrap header-container">
    <div class="d-flex navbar-brand align-items-center">
        <img src="assets/images/header/header-logo.png" alt="header-logo">
    ...
    <div class="menu-hamburger d-lg-none d-xl-none" clicked="false">
        <img src="assets/images/header/bars.svg" width="25vw"> 
    </div>
    <div class="d-none d-lg-flex d-xl-flex navbar-brand justify-content-around flex-wrap me-5 navbar-anchor">
        <a href="landing.page.html" class="fs-6 px-4">HOME</a>
        <a href="about.us.html" class="fs-6  px-4">ABOUT US</a>
        <a href="products.html" class="fs-6  px-4">PRODUCTS</a>
        <a href="services.html" class="fs-6 px-4">SERVICES</a>
        <a href="contact.us.html" class="fs-6 px-4">CONTACT US</a>
    </div>
    <div class="d-none d-lg-flex d-xl-flex navbar-brand justify-content-around flex-wrap navbar-social-media">
        <img src="assets/images/header/bx_bxl-facebook.png" alt="Facebook Logo" class="px-3">
        <img src="assets/images/header/bx_bxl-instagram.png" alt="Instagram Logo" class="px-3">
        <img src="assets/images/header/bi_twitter.png" alt="Twitter Logo" class="px-3">
        <img src="assets/images/header/ci_mail.png" alt="Email Logo" class="px-3">
    </div>
</div>
`);   
$(function () {
